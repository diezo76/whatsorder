      ...
      <div className="container mx-auto max-w-3xl text-center relative">
        ...
        >
          ...
          <a
            ...
            className="group inline-flex items-center gap-3 px-10 py-4 bg-white text-primary-700 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all duration-300"
          >
